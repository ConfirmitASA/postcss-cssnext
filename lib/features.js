...
exports.default = {
  ...
  extractCustomProperties: function extractCustomProperties(options) {
    return require("postcss-extract-custom-properties")(options);
  },
  ...
  // https://npmjs.com/package/postcss-custom-properties
  saveToJson: function saveToJson(options) {
    return require("postcss-reportal-save-to-json")(options);
  },
